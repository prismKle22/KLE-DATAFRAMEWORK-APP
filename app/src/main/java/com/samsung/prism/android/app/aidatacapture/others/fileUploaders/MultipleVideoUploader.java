...
public class MultipleVideoUploader {
    ...
    private void uploadSingleFile(final int index) {
        ...
        RequestBody dataType = createPartFromString("Video");
        ...
        call = uploadInterface.uploadAgreement(humanCentricAgreement, imageType, description, Category, subCategory, username, dataType, model, screenSize, orientation, dslr, category, location, subLocation, timing, lighting, isHumanPresent, selfie, dataType, children, props, consent, filePart, filename);
