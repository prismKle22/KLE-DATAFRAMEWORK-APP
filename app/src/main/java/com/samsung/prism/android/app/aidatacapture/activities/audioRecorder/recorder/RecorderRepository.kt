...
class RecorderRepository{
    ...
    private val dir: File = File(Environment.getExternalStorageDirectory().absolutePath + Constants.COLLECT_SOUND_DIRECTORY)
    ...
    init {
        try{
            ...
            val recorderDirectory = File(Environment.getExternalStorageDirectory().absolutePath+Constants.COLLECT_SOUND_DIRECTORY)
        ...
        if(dir.exists()){
            ...
            output = Environment.getExternalStorageDirectory().absolutePath +Constants.COLLECT_SOUND_DIRECTORY+Constants.SOUND_FILE_NAME+count+".mp3";
        }
